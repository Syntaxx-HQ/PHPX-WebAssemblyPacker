...
class WebAssemblyPackerTest extends TestCase
{
    ...
    {
        echo "Starting testPackWithoutLz4\n";
    ...
    public function testCompareFilesXXX()
    {
        ...
        $this->assertEquals(
            ...
            file_get_contents($this->fixturesDir . '/testing/no-compression.data'),
        ...
        $this->assertEquals(
            ...
            file_get_contents($this->fixturesDir . '/testing/php-web.data.js'),
    ...
    {
        echo "Starting testCompareFilesLz4\n";
        ...
        $this->assertEquals(
            file_get_contents($this->buildDir . '/php-web.data'),
            file_get_contents($this->fixturesDir . '/testing/compression.data'),
            'Data files are not equal'
        );
        ...
        $this->assertEquals(
            file_get_contents($this->buildDir . '/php-web.data.js'),
            file_get_contents($this->fixturesDir . '/testing/compression-web.data.js'),
            'JS files are not equal'
        );
        
        echo "Finished testCompareFilesLz4\n";
    }
}
